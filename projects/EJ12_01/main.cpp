...
void render(const Geometry& quad, const Geometry& cube, const Shader& s_phong, const Shader& s_normal,
...
int main(int, char* []) {
    ...
    while (window->alive()) {
        ...
        render(quad, cube, s_phong, s_normal, t_albedo, t_specular, t_normal);
        window->frame();
    }
